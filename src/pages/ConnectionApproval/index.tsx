  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2 py-8">
        ...
        <div className="text-sm font-semibold text-blue-500">{hostname}</div>
      </div>
      <div className="text-lg font-bold text-center text-blue-500">
        Connect to this site?
      </div>
      <div className="text-sm px-8 text-center text-lightcolor flex-grow">
